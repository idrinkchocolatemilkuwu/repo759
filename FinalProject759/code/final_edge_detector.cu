...
//reference: https://github.com/DanNegrut/759-2022/blob/main/Assignments/general/timing.md
//reference includes timing tasks in C++
...
int main(){
    ...
    //set up variables to time tasks
    high_resolution_clock::time_point start;
    high_resolution_clock::time_point end;
    duration<double, std::milli> duration_ms; //duration is in milliseconds

    //change image to grayscale and time it
    ...
    //compute the intensity gradient and time it
    ...
    //perform edge thinning and time it
